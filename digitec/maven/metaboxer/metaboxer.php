...
add_action( 'admin_enqueue_scripts', 'metaboxer_enqueue_scripts', 11 );
/**
 * Localize scripts for the jQuery
 *
 * @since 1.3
 */
function metaboxer_enqueue_scripts() {
	
	// Localize scripts
	wp_localize_script( 'metaboxer', 'metaboxer_vars', array(
			'text_select_all' => __( 'Select All', 'digitec' ),
			'text_deselect_all' => __( 'De-Select All', 'digitec' ),
			'text_insert_selected' => __( 'Insert Selected', 'digitec' ),
			'text_delete_selected' => __( 'Delete Selected', 'digitec' )
		)
	);
}
